...
def ner_spacy(text):
    ...
    doc = ner(text)
    ents=[ent for ent in doc.ents if ent.label_ != "DATE" and ent.label_ != "CARDINAL" and ent.label_ != "QUANTITY"]
    return ents,labels
...
def find_swift(text):
    ...
    patterns =[
        ...
        {"label":"Code Swift","pattern":[{"LOWER":"swift"},{'IS_SPACE':True,'OP':'*'},{"LOWER":"code","OP":"?"},{'IS_SPACE':True,'OP':'*'},{"IS_PUNCT":True,"OP":"?"},{"TEXT": {"REGEX": "[A-Za-z0-9]{8,11}"}}]},
